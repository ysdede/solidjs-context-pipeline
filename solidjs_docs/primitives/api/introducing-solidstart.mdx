...
source_path: solid-site\src\pages\Articles\introducing-solidstart.mdx
domain: primitives
extracted_at: "2026-02-01T15:19:26.804Z"
---
...
Filesystem routing is incredibly convenient but sometimes it is limiting so we export it as a `` component you can insert in your routes definition yourself or not. (Thanks [Hydrogen](https://shopify.dev/api/hydrogen/components/framework/fileroutes)).
