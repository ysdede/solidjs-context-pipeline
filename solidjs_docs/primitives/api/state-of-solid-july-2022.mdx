...
source_path: solid-site\src\pages\Articles\state-of-solid-july-2022.mdx
domain: primitives
extracted_at: "2026-02-01T15:19:26.801Z"
---
...
The Solid Core team feels privileged by this amazing recognition. We’re very lucky to have monthly like `Netlify` ($500), `Vercel` ($100), `Builder` ($100), `riots` ($100).
