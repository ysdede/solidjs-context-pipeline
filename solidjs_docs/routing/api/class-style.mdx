...
source_path: solid-docs\src\routes\concepts\components\class-style.mdx
domain: routing
extracted_at: "2026-02-01T15:19:26.992Z"
---
...
:::note
    ...
    Additionally, since `classList` is a pseudo-attribute, it doesn't work in prop spreads like `` or in `<Dynamic>`.
:::
