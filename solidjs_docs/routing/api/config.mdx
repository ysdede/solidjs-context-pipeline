...
source_path: solid-docs\src\routes\solid-router\getting-started\config.mdx
domain: routing
extracted_at: "2026-02-01T15:19:26.838Z"
---
...
To define a single route, a route definition object can be passed to the [`, document.getElementById("app"));
```
...
To define multiple routes, an array of route definition objects can be passed to the `, document.getElementById("app"));
```
