...
source_path: solid-docs\src\routes\solid-router\concepts\path-parameters.mdx
domain: routing
extracted_at: "2026-02-01T15:19:26.847Z"
---
...
function User() {
    ...
    return User ID: {params.id}; {/* Output: User ID: 123 */}
}
