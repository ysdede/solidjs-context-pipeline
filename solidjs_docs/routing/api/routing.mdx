...
source_path: solid-docs\src\routes\solid-start\building-your-application\routing.mdx
domain: routing
extracted_at: "2026-02-01T15:19:26.828Z"
---
...
Because `` returns a routing config object, you can use it with the router of your choice.
